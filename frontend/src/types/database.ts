...
// Regenerar con: supabase gen types typescript / MCP generate_typescript_types.
  ...
  public: {
    Tables: {
      cashier_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "cashier_accounts_cashier_id_fkey"
            columns: ["cashier_id"]
            isOneToOne: true
      ...
      profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "profiles_cashier_id_fkey"
            columns: ["cashier_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      rooms: {
        ...
        Relationships: [
          {
            foreignKeyName: "rooms_host_id_fkey1"
            columns: ["host_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      v_chips_in_circulation: {
        Row: {
          chips_in_circulation: number | null
        }
        Relationships: []
      }
      v_house_position: {
    ...
    Functions: {
      ...
      admin_adjust_balance: {
        Args: { p_delta: number; p_player: string; p_reason: string }
        Returns: number
      }
      admin_assign_float: {
        Args: { p_amount: number; p_cashier: string }
        Returns: number
      }
      ...
      cashier_load_chips: {
        Args: { p_amount: number; p_player: string }
        Returns: number
      }
      cashier_withdraw_chips: {
        Args: { p_amount: number; p_player: string }
        Returns: number
      }
      place_bet: {
